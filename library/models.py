...
class Book(models.Model):
    ...
    gutid = models.CharField(max_length=100, blank=True, null=True)
...
class Haswritten(models.Model):
    isbn = models.ForeignKey(Book, models.DO_NOTHING, db_column='isbn', primary_key=True)
...
class Likes(models.Model):
    ...
    def __str__(self):
        return (self.email+','+self.authorid)
    class Meta:
        managed = False
        db_table = 'likes'
        unique_together = (('email', 'authorid'),)
